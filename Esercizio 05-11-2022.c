...
moltiplicazione e di inserimento testo. Poi ho inserito delle funzioni if così che se si inserisce un valore 
diverso da quelli permessi ci riporti alla scelta iniziale
*/ 	
			rewind(stdin);
...
// ho impostato nel default dello switch il controllo se si inserisci un valore non indicato
