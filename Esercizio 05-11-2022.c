...
/*ho inserito la funzione rewind, così che finita l'opereazioni si riposiziona all'inizio dell'operazione pulendo il buffer 
così da non avere un errore nel ciclo del while per la scelta finale. 
Poi ho inserito delle funzioni if così che si possa inserire un valore in anche in lettera minuscola per la scelta iniziale
*/ 	
			rewind(stdin);
...
// nelle operazioni aritmetiche e nella stringa di testo ho corretto gli errori che ho segnalato sul report PDF
