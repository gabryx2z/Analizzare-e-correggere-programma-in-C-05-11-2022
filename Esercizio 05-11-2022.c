...
dell'operazione pulendo il buffer così da non avere un errore nel ciclo del while per la scelta finale anche dopo l'operazione di divisione,
moltiplicazione e di inserimento testo. Poi ho inserito delle funzioni if così che si possa inserire un valore in lettera minuscola
